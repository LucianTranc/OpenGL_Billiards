...
trancengine: main.o
	$(CC) $(CFLAGS) $(INC_PATH) $(LDFLAGS) bin/main.o bin/Game.o bin/Vector2D.o bin/AssetManager.o bin/TextureManager.o bin/Ball.o bin/Collider.o bin/Collision.o -o play

main.o: main.cpp bin/Game.o bin/Vector2D.o bin/AssetManager.o bin/TextureManager.o bin/Ball.o bin/Collider.o bin/Collision.o
...
bin/Collider.o: Collider.cpp Collider.h
	$(CC) $(CFLAGS) $(INC_PATH) Collider.cpp -c -o bin/Collider.o
